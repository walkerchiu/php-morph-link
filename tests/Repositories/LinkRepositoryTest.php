...
class LinkRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_morph_1 = factory(Link::class)->create(['is_enabled' => 1]);
        $db_morph_2 = factory(Link::class)->create();
        $db_morph_3 = factory(Link::class)->create();
        $db_morph_4 = factory(Link::class)->create();
    ...
    public function testQueryList()
    {
        ...
        // Give
        $db_morph_1 = factory(Link::class)->create();
        $db_morph_2 = factory(Link::class)->create();
        $db_morph_3 = factory(Link::class)->create();
        $db_morph_4 = factory(Link::class)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(Link::class)->create();
            $db_morph_2 = factory(Link::class)->create();
            $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Link::class)->create(['serial' => '123']);
            $db_morph_4 = factory(Link::class)->create(['serial' => '124']);
            $db_morph_5 = factory(Link::class)->create(['serial' => '125', 'is_enabled' => 1]);
            // When
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        $db_morph_1 = factory(Link::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(Link::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
