...
class LinkLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testMorphLinkLang()
    {
        ...
        $db_lang_1 = factory(LinkLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(LinkLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(LinkLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(LinkLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(LinkLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(LinkLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = LinkLang::find($db_lang_1->id);
            // Then
    ...
    public function testMorphLink()
    {
        ...
        // Get lang of record
            // When
            $record_1 = Link::find($db_morph_1->id);
            $lang_1   = LinkLang::find($db_lang_1->id);
            $lang_4   = LinkLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = Link::find($db_morph_2->id);
